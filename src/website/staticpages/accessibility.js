...
const Accessibility = () => {
  return (
    ...
    <p className='text-gray-700 font-bold text-4xl'>Accessibility for Ontarians with Disabilities</p>
    ...
    <p className='text-gray-700'>
     ...
     We endeavor to ensure that our Policy and related practices and procedures are consistent with the following principles:
    </p>

    <p className='text-gray-700 text-2xl'>1. Dignity: </p>
    <p className='text-gray-700'>
    Persons with a disability should be treated as valued customers, as deserving of high-quality service as anyone else.
    </p>

    <p className='text-gray-700 text-2xl'>2. Equality of Opportunity:  </p>
    <p className='text-gray-700'>
    Persons with a disability should be given opportunities equal to those given to others to obtain, use, and benefit from our goods and services.
    </p>

    <p className='text-gray-700 text-2xl'>3. Integration: </p>
    <p className='text-gray-700'>
    ...
    <p className='text-gray-700 text-2xl'>4. Independence:</p>
    <p className='text-gray-700'>
    Goods and services should be provided in a way that respects the independence of persons with a disability. While we should always be willing to assist a person with a disability, we should not do so without the express permission of that person.
    </p>
    ...
    <p className='text-gray-700 text-2xl'>12. Questions About This Policy</p>
    <p className='text-gray-700'>
    This Policy exists to achieve service excellence to customers with disabilities. If anyone has a question about our Policy, or if the purpose of our Policy is not clear, you may email us at support@eighty8alphaautomotive.ca. This Policy is available in alternative formats upon request.
    </p>
