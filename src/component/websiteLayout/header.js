...
const Header = () => {
  ...
  const style = {
    ...
    headerContainer:
      " bg-white shadow-md justify-between px-10 w-full h-[70px] flex items-center",
  ...
  return (
    <div className="fixed z-40 w-full top-0 ">
        ...
        <div className="flex space-x-6">
          ...
          <div className="hidden md:flex items-center justify-center p-1 space-x-6">
            <Link to="/shop">
              <p
                className={`${style.link} ${
                  location.pathname === "/shop" && style.activeLink
                }`}
              >
                Shop Car
              </p>
            ...
            <Link to="/aboutus">
              <p
                className={`${style.link} ${
                  location.pathname === "/aboutus" && style.activeLink
                }`}
              >
                About Us
              </p>
            ...
            <Link to="/contactus">
              <p
                className={`${style.link} ${
                  location.pathname === "/contactus" && style.activeLink
                }`}
              >
                Contact Us
              </p>
      ...
      >
        <div
        //className='hidden tablet:flex md:flex'
        >
          {!!(user && user._id) ? null : (
            <p
              onClick={() => {
